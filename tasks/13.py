...
# Условие:
# В терминологии сетей TCP/IP маска сети – это двоичное число, меньшее 232;
...
# 📘 Разбор номера 11835 #kege по информатике: https://t.me/informatika_kege_itpy/422
# 📘 Разбор номера 10783 #kege по информатике: https://t.me/informatika_kege_itpy/420
# 📘 Разбор номера 12947 #kege по информатике: https://t.me/informatika_kege_itpy/421
#  🐍 Библиотека ipaddress в Python предоставляет удобные инструменты для работы с IP-адресами, подсетями и масками:
#      https://t.me/informatika_kege_itpy/397
