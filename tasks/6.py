...
# 📘 Разбор номера 13843 #kege по информатике: https://t.me/informatika_kege_itpy/411
# 💡 Библиотека Turtle, чем может быть полезна на ЕГЭ: https://t.me/informatika_kege_itpy/407
# 🐍 Рисование и управление экраном в Turtle: down(), up(), dot(), screensize(), tracer(), done():
#     https://t.me/informatika_kege_itpy/410
# 🐍 Пять простейших функций из библиотеки Turtle в Python: https://t.me/informatika_kege_itpy/408
# 🐍 Давайте рассмотрим несколько функций для управления положением черепахи на экране:
#     https://t.me/informatika_kege_itpy/409
